...
const rawQuestionBank = [
  ...
  // CARDIOLOGY — TRAP
  {
    topic: "Cardiology",
    mode: "Trap",
    vignette: "72M with severe chest pain has ST elevations in II, III, and aVF. BP is 86/54 mmHg, lungs are clear, and JVP is elevated. Which medication should be avoided initially?",
    answers: ["Aspirin", "Nitroglycerin", "Heparin", "Atorvastatin"],
    correct: 1,
    explanation: "Trap: do not give nitroglycerin in suspected right ventricular infarction with hypotension, clear lungs, and elevated JVP. Preload reduction can worsen shock."
  },
  {
    topic: "Cardiology",
    mode: "Trap",
    vignette: "68F with atrial fibrillation has HR 160/min, BP 78/44 mmHg, confusion, and pulmonary edema. What is the next step?",
    answers: ["IV diltiazem", "Immediate synchronized cardioversion", "Oral metoprolol", "Schedule outpatient cardiology follow-up"],
    correct: 1,
    explanation: "Trap: unstable atrial fibrillation is not treated first with rate control. Hypotension, confusion, and pulmonary edema require immediate synchronized cardioversion."
  },
  {
    topic: "Cardiology",
    mode: "Trap",
    vignette: "46M has abrupt tearing chest pain radiating to the back and unequal arm blood pressures. ECG shows nonspecific changes. What should be avoided as the initial assumption?",
    answers: ["Aortic dissection", "Musculoskeletal pain", "Hypertensive emergency", "Possible vascular catastrophe"],
    correct: 1,
    explanation: "Trap: do not dismiss tearing back-radiating chest pain with pulse/BP asymmetry as musculoskeletal pain. This is aortic dissection until proven otherwise."
  },
  {
    topic: "Cardiology",
    mode: "Trap",
    vignette: "35F has pleuritic chest pain after viral illness that improves leaning forward. ECG shows diffuse ST elevations. Troponin is mildly elevated. What is the most likely diagnosis?",
    answers: ["STEMI requiring emergent PCI", "Acute pericarditis", "GERD", "Panic attack"],
    correct: 1,
    explanation: "Trap: diffuse ST elevation with positional pleuritic pain is pericarditis, not automatically STEMI. STEMI usually has regional ST elevations."
  },
  {
    topic: "Cardiology",
    mode: "Trap",
    vignette: "Patient has exertional dyspnea, angina, syncope, and a systolic murmur radiating to the carotids. Which medication strategy is not definitive treatment?",
    answers: ["Valve replacement evaluation", "Diuretics as sole definitive therapy", "Echocardiography", "Cardiology referral"],
    correct: 1,
    explanation: "Trap: symptomatic severe aortic stenosis needs valve replacement evaluation. Diuretics may help congestion but are not definitive and can worsen preload dependence."
  },
  {
    topic: "Cardiology",
    mode: "Trap",
    vignette: "Young athlete with exertional syncope and family history of sudden death has a systolic murmur louder with standing. What advice is unsafe before full evaluation?",
    answers: ["Avoid competitive sports", "Echocardiography", "Return to competitive play if symptoms improve with hydration", "Family history assessment"],
    correct: 2,
    explanation: "Trap: do not clear suspected hypertrophic cardiomyopathy for sports based on hydration. Exertional syncope with sudden-death family history requires evaluation and restriction."
  },
  {
    topic: "Cardiology",
    mode: "Trap",
    vignette: "58M with prior MI has orthopnea, leg edema, crackles, and S3. He denies chest pain. What should not distract from the diagnosis?",
    answers: ["Absence of chest pain", "Orthopnea", "S3 gallop", "Bilateral edema"],
    correct: 0,
    explanation: "Trap: heart failure exacerbation does not require chest pain. Orthopnea, edema, crackles, and S3 are the key volume-overload clues."
  },
  {
    topic: "Cardiology",
    mode: "Trap",
    vignette: "63F has chest pressure at rest and new ST depressions. Initial troponin is negative. What is the correct interpretation?",
    answers: ["ACS is excluded", "ACS remains possible", "This is stable angina", "This is pericarditis"],
    correct: 1,
    explanation: "Trap: a negative initial troponin does not exclude early ACS. Rest pain with new ischemic ECG changes is acute coronary syndrome."
  },
  {
    topic: "Cardiology",
    mode: "Trap",
    vignette: "Chest trauma patient has hypotension, JVD, muffled heart sounds, and equal breath sounds. What should not be the leading diagnosis?",
    answers: ["Cardiac tamponade", "Tension pneumothorax", "Obstructive shock", "Pericardial blood accumulation"],
    correct: 1,
    explanation: "Trap: tension pneumothorax usually has unilateral absent breath sounds and often tracheal deviation. Equal breath sounds with Beck triad favors tamponade."
  },
  {
    topic: "Cardiology",
    mode: "Trap",
    vignette: "60F has pleuritic chest pain and dyspnea after a long flight. Chest x-ray is normal. What is the main trap?",
    answers: ["Normal chest x-ray excludes PE", "Recent immobility increases PE risk", "Tachycardia supports PE", "Hypoxemia supports PE"],
    correct: 0,
    explanation: "Trap: a normal chest x-ray does not exclude pulmonary embolism. PE often has a normal or nonspecific chest x-ray."
  },
  ...
  // PULMONOLOGY — TRAP
  {
    topic: "Pulmonology",
    mode: "Trap",
    vignette: "Trauma patient has absent breath sounds on one side, hypotension, severe respiratory distress, and tracheal deviation. What should happen before chest x-ray?",
    answers: ["Needle decompression", "CT chest", "Formal pulmonary function testing", "Outpatient observation"],
    correct: 0,
    explanation: "Trap: do not wait for imaging in tension pneumothorax. Clinical diagnosis with shock requires immediate needle decompression."
  },
  {
    topic: "Pulmonology",
    mode: "Trap",
    vignette: "Young woman has cough, dyspnea, erythema nodosum, and bilateral hilar lymphadenopathy. A TB exposure is mentioned. What is the trap?",
    answers: ["Assuming all hilar adenopathy is TB", "Recognizing sarcoidosis", "Considering systemic disease", "Noting erythema nodosum"],
    correct: 0,
    explanation: "Trap: bilateral hilar lymphadenopathy with erythema nodosum strongly suggests sarcoidosis; TB exposure is distracting unless the full TB pattern is present."
  },
  {
    topic: "Pulmonology",
    mode: "Trap",
    vignette: "55M has months of cough, night sweats, weight loss, hemoptysis, and upper-lobe cavitation. What is unsafe?",
    answers: ["Airborne isolation", "Sputum testing", "Empiric outpatient cough suppressant only", "TB evaluation"],
    correct: 2,
    explanation: "Trap: chronic constitutional symptoms with hemoptysis and cavitation require TB evaluation and isolation precautions, not symptomatic outpatient treatment only."
  },
  {
    topic: "Pulmonology",
    mode: "Trap",
    vignette: "Patient with heart disease has acute dyspnea, orthopnea, diffuse crackles, and pink frothy sputum. He is wheezing. What is the trap?",
    answers: ["Calling it COPD solely because of wheeze", "Recognizing pulmonary edema", "Assessing volume status", "Considering cardiac history"],
    correct: 0,
    explanation: "Trap: wheezing can occur in pulmonary edema. Orthopnea, crackles, pink frothy sputum, and cardiac disease point to cardiogenic pulmonary edema."
  },
  {
    topic: "Pulmonology",
    mode: "Trap",
    vignette: "27F has episodic wheezing and nighttime cough but normal lung exam in clinic. What is the trap?",
    answers: ["Normal exam excludes asthma", "Bronchodilator response supports asthma", "Night symptoms support asthma", "Triggers support asthma"],
    correct: 0,
    explanation: "Trap: asthma can have a normal exam between episodes. Episodic nighttime symptoms and bronchodilator response remain key."
  },
  {
    topic: "Pulmonology",
    mode: "Trap",
    vignette: "Patient with leg immobilization has sudden pleuritic dyspnea, tachycardia, and hypoxemia. Chest x-ray is normal. What diagnosis remains high?",
    answers: ["Pulmonary embolism", "Pneumonia", "COPD exacerbation", "Pulmonary edema"],
    correct: 0,
    explanation: "Trap: normal chest x-ray does not rule out PE. Risk factor plus acute pleuritic dyspnea and hypoxemia is the key pattern."
  },
  {
    topic: "Pulmonology",
    mode: "Trap",
    vignette: "Patient has bird exposure, cough, dyspnea, and symptoms worse after cleaning cages. What is the trap?",
    answers: ["Ignoring exposure timing", "Diagnosing hypersensitivity pneumonitis", "Recognizing antigen-triggered disease", "Asking about occupational/environmental exposure"],
    correct: 0,
    explanation: "Trap: exposure timing is the decisive clue. Recurrent symptoms after bird antigen exposure fit hypersensitivity pneumonitis."
  },
  {
    topic: "Pulmonology",
    mode: "Trap",
    vignette: "Septic patient develops severe hypoxemia and bilateral infiltrates. Echo is normal and there is no volume overload. What should not be assumed?",
    answers: ["All bilateral infiltrates are cardiogenic edema", "ARDS can follow sepsis", "Noncardiogenic edema exists", "Hypoxemia is severe"],
    correct: 0,
    explanation: "Trap: bilateral infiltrates are not automatically heart failure. Sepsis plus severe hypoxemia without cardiac overload fits ARDS."
  },
  {
    topic: "Pulmonology",
    mode: "Trap",
    vignette: "Long-term smoker has weight loss and spiculated upper-lobe nodule. He says allergies have worsened. What is the trap?",
    answers: ["Attributing red-flag imaging to allergies", "Considering lung cancer", "Noting weight loss", "Noting smoking history"],
    correct: 0,
    explanation: "Trap: allergy symptoms do not explain a spiculated nodule with weight loss in a smoker. Treat as lung cancer until proven otherwise."
  },
  {
    topic: "Pulmonology",
    mode: "Trap",
    vignette: "COPD patient has increased dyspnea, wheeze, cough, and sputum but no focal infiltrate. What is the most likely diagnosis?",
    answers: ["COPD exacerbation", "Lobar pneumonia", "Aortic dissection", "Pericarditis"],
    correct: 0,
    explanation: "Trap: absence of focal infiltrate makes pneumonia less likely. Increased dyspnea, wheeze, and sputum in COPD fits exacerbation."
  },
  ...
  // NEPHROLOGY — TRAP
  {
    topic: "Nephrology",
    mode: "Trap",
    vignette: "Renal failure patient has potassium 7.1 mEq/L with peaked T waves and QRS widening. What is the first priority?",
    answers: ["IV calcium gluconate", "Sodium polystyrene sulfonate only", "Low-potassium diet", "Wait for repeat potassium"],
    correct: 0,
    explanation: "Trap: do not wait or use slow potassium removal first when ECG changes are present. IV calcium stabilizes the myocardium immediately."
  },
  {
    topic: "Nephrology",
    mode: "Trap",
    vignette: "24M has gross hematuria 2 days after sore throat and normal complement. What is the trap?",
    answers: ["Calling it PSGN because of sore throat", "Recognizing IgA nephropathy", "Using timing after infection", "Checking complement"],
    correct: 0,
    explanation: "Trap: poststreptococcal GN occurs weeks after infection and often has low complement. Hematuria within days suggests IgA nephropathy."
  },
  {
    topic: "Nephrology",
    mode: "Trap",
    vignette: "Septic ICU patient develops AKI with muddy brown casts. What should not be the primary diagnosis?",
    answers: ["Acute tubular necrosis", "Prerenal azotemia only", "Ischemic tubular injury", "Sepsis-associated AKI"],
    correct: 1,
    explanation: "Trap: muddy brown casts indicate tubular injury, not purely prerenal azotemia."
  },
  {
    topic: "Nephrology",
    mode: "Trap",
    vignette: "Diabetic patient has gradual CKD and heavy proteinuria over years. What is the trap?",
    answers: ["Assuming all proteinuria needs renal biopsy first", "Recognizing diabetic nephropathy", "Checking diabetes duration", "Assessing retinopathy/proteinuria"],
    correct: 0,
    explanation: "Trap: classic long-standing diabetes with gradual nephrotic proteinuria usually points to diabetic nephropathy; biopsy is for atypical features."
  },
  {
    topic: "Nephrology",
    mode: "Trap",
    vignette: "Patient has bilateral renal cysts and family history of dialysis. What should not distract from ADPKD?",
    answers: ["One prior UTI", "Bilateral enlarged cystic kidneys", "Family history", "Recurrent hematuria"],
    correct: 0,
    explanation: "Trap: a prior UTI does not explain bilateral inherited cystic kidney disease."
  },
  {
    topic: "Nephrology",
    mode: "Trap",
    vignette: "Euvolemic patient with small cell lung cancer has sodium 121 mEq/L and concentrated urine. What is the trap?",
    answers: ["Giving free water because sodium is low", "Recognizing SIADH", "Checking urine osmolality", "Assessing volume status"],
    correct: 0,
    explanation: "Trap: hyponatremia from SIADH is worsened by excess free water. The urine is inappropriately concentrated despite low sodium."
  },
  {
    topic: "Nephrology",
    mode: "Trap",
    vignette: "Long-standing hypertensive patient has gradual CKD, mild proteinuria, and bland urine sediment. What is the most likely diagnosis?",
    answers: ["Hypertensive nephrosclerosis", "IgA nephropathy", "Acute interstitial nephritis", "Postrenal obstruction"],
    correct: 0,
    explanation: "Trap: bland gradual CKD with decades of hypertension is hypertensive nephrosclerosis, not an acute inflammatory nephritis."
  },
  {
    topic: "Nephrology",
    mode: "Trap",
    vignette: "Patient has fever, urinary symptoms, nausea, flank pain, and CVA tenderness. What should not be called uncomplicated cystitis?",
    answers: ["Pyelonephritis", "Simple cystitis", "Lower UTI only", "Asymptomatic bacteriuria"],
    correct: 0,
    explanation: "Trap: flank pain, fever, nausea, and CVA tenderness indicate pyelonephritis, not simple cystitis."
  },
  {
    topic: "Nephrology",
    mode: "Trap",
    vignette: "Patient has edema and heavy proteinuria without red blood cell casts. What syndrome is this?",
    answers: ["Nephrotic syndrome", "Nephritic syndrome", "Postrenal obstruction", "Acute tubular necrosis"],
    correct: 0,
    explanation: "Trap: heavy proteinuria and edema are nephrotic. Nephritic syndrome centers on hematuria, hypertension, and RBC casts."
  },
  {
    topic: "Nephrology",
    mode: "Trap",
    vignette: "Patient with colicky flank-to-groin pain is pacing and has hematuria but no fever. What is the trap?",
    answers: ["Calling it pyelonephritis without infection signs", "Recognizing ureteral stone", "Noting hematuria", "Noting colicky pain"],
    correct: 0,
    explanation: "Trap: severe flank pain alone is not pyelonephritis. Afebrile colicky flank-to-groin pain with hematuria fits ureteral stone."
  },
  ...
  // GASTROENTEROLOGY/HEPATOLOGY — TRAP
  {
    topic: "Gastroenterology/Hepatology",
    mode: "Trap",
    vignette: "49F has postprandial burning chest discomfort, sour taste, and symptoms worse when supine. Cardiac history is negative. What is the most likely diagnosis?",
    answers: ["GERD", "Acute MI", "Acute pancreatitis", "Esophageal rupture"],
    correct: 0,
    explanation: "Trap: chest discomfort is not automatically cardiac. Regurgitation and supine worsening point to GERD."
  },
  {
    topic: "Gastroenterology/Hepatology",
    mode: "Trap",
    vignette: "Cirrhotic patient has massive hematemesis after one episode of retching. What is the trap?",
    answers: ["Assuming Mallory-Weiss because retching occurred", "Recognizing variceal bleeding", "Assessing portal hypertension", "Resuscitating urgently"],
    correct: 0,
    explanation: "Trap: retching can distract, but cirrhosis with massive hematemesis is variceal bleeding until proven otherwise."
  },
  {
    topic: "Gastroenterology/Hepatology",
    mode: "Trap",
    vignette: "Patient has RUQ pain after fatty food. Prior episodes resolved quickly, but now pain persists with fever and Murphy sign. What is the diagnosis?",
    answers: ["Acute cholecystitis", "Biliary colic", "GERD", "IBS"],
    correct: 0,
    explanation: "Trap: do not call persistent febrile RUQ pain biliary colic. Fever and Murphy sign indicate acute cholecystitis."
  },
  {
    topic: "Gastroenterology/Hepatology",
    mode: "Trap",
    vignette: "Alcohol user has severe epigastric pain radiating to the back and vomiting. What should not be the default label?",
    answers: ["GERD", "Acute pancreatitis", "Alcohol-associated pancreatitis", "Pancreatic inflammation"],
    correct: 0,
    explanation: "Trap: epigastric pain after alcohol is not always reflux. Back radiation and vomiting fit acute pancreatitis."
  },
  {
    topic: "Gastroenterology/Hepatology",
    mode: "Trap",
    vignette: "Patient labeled as IBS has chronic diarrhea, bloating, weight loss, and iron deficiency that improve when avoiding wheat. What is the trap?",
    answers: ["Accepting IBS despite iron deficiency", "Recognizing celiac disease", "Noting malabsorption", "Checking tissue transglutaminase antibody"],
    correct: 0,
    explanation: "Trap: iron deficiency and weight loss are not typical IBS features. Malabsorption with gluten association points to celiac disease."
  },
  {
    topic: "Gastroenterology/Hepatology",
    mode: "Trap",
    vignette: "Patient has watery diarrhea after clindamycin. What is the key trap?",
    answers: ["Calling it viral gastroenteritis without considering antibiotics", "Recognizing C difficile", "Checking stool toxin when appropriate", "Assessing severity"],
    correct: 0,
    explanation: "Trap: recent antibiotic exposure is the key clue for C difficile infection."
  },
  {
    topic: "Gastroenterology/Hepatology",
    mode: "Trap",
    vignette: "Chronic hepatitis C patient now has ascites, jaundice, easy bruising, edema, and spider angiomas. What is the diagnosis?",
    answers: ["Decompensated cirrhosis", "Simple acute hepatitis", "IBS", "GERD"],
    correct: 0,
    explanation: "Trap: chronic liver disease with ascites/coagulopathy signs is decompensated cirrhosis, not uncomplicated hepatitis."
  },
  {
    topic: "Gastroenterology/Hepatology",
    mode: "Trap",
    vignette: "Patient has LLQ pain and fever with sigmoid inflammation on CT. What is the trap?",
    answers: ["Calling it appendicitis because abdominal pain is present", "Recognizing diverticulitis", "Using location", "Using CT findings"],
    correct: 0,
    explanation: "Trap: appendicitis is classically RLQ. LLQ pain with sigmoid inflammation is diverticulitis."
  },
  {
    topic: "Gastroenterology/Hepatology",
    mode: "Trap",
    vignette: "Patient has years of abdominal discomfort with alternating bowel habits, relief after bowel movements, and no alarm features. What is the diagnosis?",
    answers: ["Irritable bowel syndrome", "Colon cancer", "Crohn disease", "C difficile infection"],
    correct: 0,
    explanation: "Trap: chronic bowel-related discomfort without alarm features favors IBS; do not overcall inflammatory or malignant disease without red flags."
  },
  {
    topic: "Gastroenterology/Hepatology",
    mode: "Trap",
    vignette: "Patient has progressive dysphagia from solids to liquids and weight loss. What should not be done?",
    answers: ["Reassure as uncomplicated GERD", "Evaluate for esophageal cancer", "Treat as alarm symptom", "Consider endoscopy"],
    correct: 0,
    explanation: "Trap: progressive dysphagia with weight loss is an alarm symptom and should not be dismissed as uncomplicated GERD."
  },
  ...
  // ENDOCRINOLOGY — TRAP
  {
    topic: "Endocrinology",
    mode: "Trap",
    vignette: "DKA patient has potassium 2.9 mEq/L before insulin. What is the trap?",
    answers: ["Start insulin immediately without potassium", "Replete potassium first", "Monitor potassium closely", "Recognize total body potassium depletion"],
    correct: 0,
    explanation: "Trap: insulin shifts potassium intracellularly and can cause fatal hypokalemia. If potassium is low, replete potassium before insulin."
  },
  {
    topic: "Endocrinology",
    mode: "Trap",
    vignette: "Older type 2 diabetic patient has glucose 950 mg/dL, confusion, severe dehydration, high osmolality, and minimal ketones. What is the diagnosis?",
    answers: ["Hyperosmolar hyperglycemic state", "Diabetic ketoacidosis", "Hypoglycemia", "Thyroid storm"],
    correct: 0,
    explanation: "Trap: extreme hyperglycemia with hyperosmolality and minimal ketosis in type 2 diabetes is HHS, not DKA."
  },
  {
    topic: "Endocrinology",
    mode: "Trap",
    vignette: "Patient with weight loss, tremor, heat intolerance, palpitations, and goiter says it is stress. What is the trap?",
    answers: ["Attributing thyrotoxicosis to anxiety alone", "Recognizing hyperthyroidism", "Checking thyroid function", "Noting goiter"],
    correct: 0,
    explanation: "Trap: anxiety can mimic palpitations, but weight loss, heat intolerance, tremor, and goiter point to hyperthyroidism."
  },
  {
    topic: "Endocrinology",
    mode: "Trap",
    vignette: "Patient has fatigue, weight gain, constipation, dry skin, cold intolerance, and bradycardia. What is the diagnosis?",
    answers: ["Hypothyroidism", "Depression only", "Hyperthyroidism", "Pheochromocytoma"],
    correct: 0,
    explanation: "Trap: fatigue alone can be depression, but constipation, cold intolerance, dry skin, weight gain, and bradycardia point to hypothyroidism."
  },
  {
    topic: "Endocrinology",
    mode: "Trap",
    vignette: "Patient has resistant hypertension, hypokalemia, and metabolic alkalosis without diuretics. What should not be missed?",
    answers: ["Primary hyperaldosteronism", "Essential hypertension only", "SIADH", "Addison disease"],
    correct: 0,
    explanation: "Trap: resistant hypertension with hypokalemia is not simple essential hypertension. Think primary hyperaldosteronism."
  },
  {
    topic: "Endocrinology",
    mode: "Trap",
    vignette: "Patient has central obesity, easy bruising, purple striae, proximal weakness, and hypertension. What is the trap?",
    answers: ["Calling it simple weight gain", "Recognizing Cushing syndrome", "Noting catabolic skin findings", "Noting proximal weakness"],
    correct: 0,
    explanation: "Trap: simple obesity does not cause easy bruising, purple striae, and proximal muscle weakness. This is Cushing syndrome."
  },
  {
    topic: "Endocrinology",
    mode: "Trap",
    vignette: "Patient has irregular menses, acne, hirsutism, and infertility. What is the diagnosis?",
    answers: ["PCOS", "Normal puberty", "Menopause", "Hypothyroidism only"],
    correct: 0,
    explanation: "Trap: irregular menses plus hyperandrogenism is not just nonspecific cycle variation. It strongly suggests PCOS."
  },
  {
    topic: "Endocrinology",
    mode: "Trap",
    vignette: "Patient has recurrent stones, bone pain, constipation, high calcium, and elevated PTH. What is the diagnosis?",
    answers: ["Primary hyperparathyroidism", "Vitamin D deficiency", "Hypocalcemia", "SIADH"],
    correct: 0,
    explanation: "Trap: high calcium with high PTH is primary hyperparathyroidism, not vitamin D deficiency."
  },
  {
    topic: "Endocrinology",
    mode: "Trap",
    vignette: "Postmenopausal patient has low-trauma wrist fracture. What is the trap?",
    answers: ["Calling it normal aging only", "Recognizing osteoporosis", "Evaluating bone density", "Treating fragility fracture seriously"],
    correct: 0,
    explanation: "Trap: a low-trauma fracture is not just normal aging. It indicates fragility fracture/osteoporosis."
  },
  {
    topic: "Endocrinology",
    mode: "Trap",
    vignette: "Nondiabetic patient has fasting sweating, tremor, confusion, and relief after juice. What is the trap?",
    answers: ["Calling it panic without checking glucose", "Recognizing hypoglycemia", "Considering insulinoma", "Using Whipple triad"],
    correct: 0,
    explanation: "Trap: adrenergic symptoms can mimic panic, but fasting neuroglycopenia relieved by glucose suggests hypoglycemia/insulinoma."
  },
  ...
  // HEMATOLOGY/ONCOLOGY — TRAP
  {
    topic: "Hematology/Oncology",
    mode: "Trap",
    vignette: "Patient has microcytic anemia, heavy menstrual bleeding, and low ferritin. What is the trap?",
    answers: ["Assuming thalassemia without considering iron loss", "Recognizing iron deficiency", "Checking ferritin", "Identifying blood loss"],
    correct: 0,
    explanation: "Trap: microcytosis with low ferritin and bleeding is iron deficiency anemia, not thalassemia trait."
  },
  {
    topic: "Hematology/Oncology",
    mode: "Trap",
    vignette: "Patient has macrocytosis, glossitis, gait instability, and numb feet. What should not be given alone without considering the correct deficiency?",
    answers: ["Folate alone", "Vitamin B12 replacement", "Neurologic assessment", "Checking B12 level"],
    correct: 0,
    explanation: "Trap: folate can improve anemia but not neurologic injury from B12 deficiency. Neurologic findings point to vitamin B12 deficiency."
  },
  {
    topic: "Hematology/Oncology",
    mode: "Trap",
    vignette: "Patient has jaundice, dark urine, anemia, reticulocytosis, and splenomegaly. What is the trap?",
    answers: ["Calling it iron deficiency because anemia is present", "Recognizing hemolysis", "Noting indirect bilirubin", "Noting reticulocytosis"],
    correct: 0,
    explanation: "Trap: anemia with jaundice, dark urine, and reticulocytosis is hemolysis, not iron deficiency."
  },
  {
    topic: "Hematology/Oncology",
    mode: "Trap",
    vignette: "Child with sickle cell disease has fever. What is unsafe?",
    answers: ["Treat fever urgently", "Delay evaluation because fever is common", "Consider encapsulated organisms", "Assess for sepsis"],
    correct: 1,
    explanation: "Trap: fever in sickle cell disease is high risk due to functional asplenia and requires urgent evaluation/treatment."
  },
  {
    topic: "Hematology/Oncology",
    mode: "Trap",
    vignette: "Patient has low RBCs, WBCs, and platelets with fatigue, infections, and bruising. What is the trap?",
    answers: ["Calling it isolated ITP", "Recognizing pancytopenia", "Considering marrow failure", "Checking CBC differential"],
    correct: 0,
    explanation: "Trap: ITP causes isolated thrombocytopenia. Pancytopenia suggests marrow failure such as aplastic anemia."
  },
  {
    topic: "Hematology/Oncology",
    mode: "Trap",
    vignette: "Patient has thrombocytopenia, confusion, renal injury, fever, and schistocytes. What is the trap?",
    answers: ["Waiting for confirmatory ADAMTS13 before treatment", "Recognizing TTP", "Starting urgent plasma exchange", "Noting MAHA"],
    correct: 0,
    explanation: "Trap: suspected TTP is treated urgently; do not wait for confirmatory ADAMTS13 testing."
  },
  {
    topic: "Hematology/Oncology",
    mode: "Trap",
    vignette: "Patient has gum bleeding, infections, anemia, thrombocytopenia, and many immature cells on smear. What should not be assumed?",
    answers: ["Dental disease alone", "Acute leukemia", "Marrow failure", "Hematologic malignancy"],
    correct: 0,
    explanation: "Trap: gum bleeding may be misattributed to dental disease, but cytopenias and immature cells suggest acute leukemia."
  },
  {
    topic: "Hematology/Oncology",
    mode: "Trap",
    vignette: "Older patient has back pain, recurrent infections, renal dysfunction, high protein, and lytic bone lesions. What is the trap?",
    answers: ["Calling back pain degenerative only", "Recognizing multiple myeloma", "Noting CRAB features", "Checking serum protein studies"],
    correct: 0,
    explanation: "Trap: back pain in older adults is common, but lytic lesions plus renal dysfunction, infections, and high protein point to multiple myeloma."
  },
  {
    topic: "Hematology/Oncology",
    mode: "Trap",
    vignette: "Patient on warfarin has INR 9.2 but no bleeding. What should not be given routinely?",
    answers: ["Protamine", "Vitamin K", "Holding warfarin", "Bleeding assessment"],
    correct: 0,
    explanation: "Trap: protamine reverses heparin, not warfarin. Warfarin reversal uses vitamin K, and PCC/FFP if serious bleeding."
  },
  {
    topic: "Hematology/Oncology",
    mode: "Trap",
    vignette: "Young adult has painless lymphadenopathy, B symptoms, and pruritus. What is the trap?",
    answers: ["Assuming reactive node because patient is young", "Recognizing Hodgkin lymphoma", "Noting B symptoms", "Evaluating persistent lymphadenopathy"],
    correct: 0,
    explanation: "Trap: young age does not make persistent painless lymphadenopathy with B symptoms benign. Think Hodgkin lymphoma."
  },
  ...
  // INFECTIOUS DISEASE — TRAP
  {
    topic: "Infectious Disease",
    mode: "Trap",
    vignette: "Patient with pneumonia has persistent hypotension despite fluids and elevated lactate. What should not delay antibiotics?",
    answers: ["Waiting for all cultures if it delays treatment", "Obtaining cultures promptly", "Recognizing septic shock", "Starting broad-spectrum antibiotics"],
    correct: 0,
  ...
  },
  {
    topic: "Infectious Disease",
    mode: "Trap",
    vignette: "Patient has fever, neck stiffness, confusion, and petechial rash. What is unsafe?",
    answers: ["Delaying empiric antibiotics for imaging when unstable", "Recognizing bacterial meningitis", "Starting urgent therapy", "Droplet precautions"],
    correct: 0,
    explanation: "Trap: suspected bacterial meningitis requires urgent empiric antibiotics. Imaging should not delay treatment when clinical concern is high."
  },
  {
    topic: "Infectious Disease",
    mode: "Trap",
    vignette: "Patient has fever, confusion, personality change, focal seizures, and temporal lobe findings. What treatment should not be delayed?",
    answers: ["Acyclovir", "Oseltamivir", "Fluconazole", "Albendazole"],
    correct: 0,
    explanation: "Trap: HSV encephalitis causes temporal lobe encephalitis and requires immediate acyclovir."
  },
  {
    topic: "Infectious Disease",
    mode: "Trap",
    vignette: "Patient with prosthetic valve has fever and new murmur. What is the trap?",
    answers: ["Ignoring endocarditis because fever is nonspecific", "Obtaining blood cultures", "Considering valve infection", "Looking for embolic signs"],
    correct: 0,
    explanation: "Trap: fever plus new murmur in a prosthetic valve patient is infective endocarditis until proven otherwise."
  },
  {
    topic: "Infectious Disease",
    mode: "Trap",
    vignette: "Stable immunocompetent patient has nonbloody diarrhea after undercooked poultry. What is the trap?",
    answers: ["Giving antibiotics automatically for all foodborne diarrhea", "Supportive care", "Hydration", "Assessing severity"],
    correct: 0,
    explanation: "Trap: uncomplicated nonbloody foodborne diarrhea is often supportive care; antibiotics are not automatic."
  },
  {
    topic: "Infectious Disease",
    mode: "Trap",
    vignette: "Unvaccinated child has fever, cough, coryza, conjunctivitis, and face-first rash. What is the trap?",
    answers: ["Calling it nonspecific viral exanthem", "Recognizing measles", "Isolation", "Public health awareness"],
    correct: 0,
    explanation: "Trap: cough, coryza, conjunctivitis, and cephalocaudal rash in an unvaccinated child is measles, not a generic rash."
  },
  {
    topic: "Infectious Disease",
    mode: "Trap",
    vignette: "Patient has painful genital ulcer with tender lymphadenopathy. What is the trap?",
    answers: ["Calling it syphilis because it is an ulcer", "Recognizing chancroid", "Using pain as a clue", "Checking STI history"],
    correct: 0,
  ...
  },
  {
    topic: "Infectious Disease",
    mode: "Trap",
    vignette: "Advanced HIV patient has dry cough, hypoxemia, and diffuse bilateral infiltrates. What is the trap?",
    answers: ["Expecting lobar consolidation for all pneumonias", "Recognizing Pneumocystis pneumonia", "Noting hypoxemia", "Noting advanced HIV"],
    correct: 0,
    explanation: "Trap: Pneumocystis pneumonia often causes diffuse bilateral infiltrates, not focal lobar consolidation."
  },
  {
    topic: "Infectious Disease",
    mode: "Trap",
    vignette: "Patient develops jaundice and dark urine weeks after needlestick injury. What is the trap?",
    answers: ["Calling it chronic hepatitis immediately", "Recognizing acute hepatitis B", "Using exposure timing", "Noting symptomatic hepatitis"],
    correct: 0,
    explanation: "Trap: symptomatic hepatitis weeks after exposure is acute hepatitis B; chronicity requires persistence over time."
  },
  {
    topic: "Infectious Disease",
    mode: "Trap",
    vignette: "Traveler from West Africa has recurrent fevers, chills, sweats, anemia, and jaundice. What is the trap?",
    answers: ["Calling it flu because fever comes and goes", "Recognizing malaria", "Considering travel", "Noting hemolysis"],
    correct: 0,
    explanation: "Trap: cyclic fever with anemia/jaundice after endemic travel is malaria, not routine influenza."
  },
  ...
  // NEUROLOGY — TRAP
  {
    topic: "Neurology",
    mode: "Trap",
    vignette: "Patient develops sudden aphasia and arm weakness 2 hours ago. Symptoms persist and glucose is normal. What should not happen?",
    answers: ["Delay stroke evaluation because symptoms may resolve", "Activate acute stroke pathway", "Check eligibility for reperfusion", "Obtain urgent neuroimaging"],
    correct: 0,
    explanation: "Trap: do not wait for persistent focal deficits to resolve. Acute stroke evaluation is time-sensitive."
  },
  {
    topic: "Neurology",
    mode: "Trap",
    vignette: "Patient with migraine history has abrupt worst headache of life with neck stiffness. What is the trap?",
    answers: ["Assuming migraine because of history", "Recognizing subarachnoid hemorrhage", "Using thunderclap onset", "Taking meningismus seriously"],
    correct: 0,
    explanation: "Trap: migraine history does not explain thunderclap maximal-at-onset headache with meningismus. Think SAH."
  },
  {
    topic: "Neurology",
    mode: "Trap",
    vignette: "Child has a generalized seizure lasting 7 minutes. What is the trap?",
    answers: ["Waiting indefinitely because many seizures stop", "Treating as status epilepticus", "Giving rescue benzodiazepine when indicated", "Protecting airway"],
    correct: 0,
    explanation: "Trap: seizure lasting more than 5 minutes is status epilepticus and should be treated."
  },
  {
    topic: "Neurology",
    mode: "Trap",
    vignette: "Patient has unilateral facial weakness involving the forehead and eye closure, with no limb symptoms. What is the trap?",
    answers: ["Calling every facial droop stroke", "Recognizing Bell palsy", "Checking forehead involvement", "Checking limb deficits"],
    correct: 0,
    explanation: "Trap: forehead involvement suggests peripheral facial nerve palsy rather than typical cortical stroke."
  },
  {
    topic: "Neurology",
    mode: "Trap",
    vignette: "Patient has ascending weakness and areflexia after diarrhea. What must be monitored closely?",
    answers: ["Respiratory function", "Visual acuity only", "Serum calcium only", "Skin biopsy"],
    correct: 0,
    explanation: "Trap: Guillain-Barré can cause respiratory failure. Monitor respiratory function, not just limb strength."
  },
  {
    topic: "Neurology",
    mode: "Trap",
    vignette: "Older patient has gradual memory decline and impaired daily function. What is the trap?",
    answers: ["Calling it normal aging despite functional impairment", "Recognizing dementia", "Assessing ADLs/IADLs", "Considering Alzheimer disease"],
    correct: 0,
    explanation: "Trap: normal aging does not impair finances/navigation/basic function. Functional decline suggests dementia."
  },
  {
    topic: "Neurology",
    mode: "Trap",
    vignette: "Patient has ptosis and diplopia worsening with repeated use and improving with rest. What is the trap?",
    answers: ["Attributing it to eye strain only", "Recognizing myasthenia gravis", "Noting fatigability", "Checking bulbar/respiratory symptoms"],
    correct: 0,
    explanation: "Trap: fatigable ocular weakness is myasthenia gravis until proven otherwise, not simple eye strain."
  },
  {
    topic: "Neurology",
    mode: "Trap",
    vignette: "Patient has rest tremor, bradykinesia, rigidity, and shuffling gait. What is the trap?",
    answers: ["Calling it essential tremor because hands shake", "Recognizing Parkinson disease", "Noting rest tremor", "Noting bradykinesia"],
    correct: 0,
    explanation: "Trap: essential tremor is typically action tremor. Rest tremor with bradykinesia/rigidity suggests Parkinson disease."
  },
  {
    topic: "Neurology",
    mode: "Trap",
    vignette: "Young adult has episodes of neurologic deficits months apart involving different CNS regions. What is the trap?",
    answers: ["Calling it anxiety because symptoms fluctuate", "Recognizing multiple sclerosis", "Using dissemination in time", "Using dissemination in space"],
    correct: 0,
    explanation: "Trap: recurrent objective neurologic deficits separated in time and space suggest MS, not anxiety."
  },
  {
    topic: "Neurology",
    mode: "Trap",
    vignette: "Patient has recurrent vertigo lasting hours with tinnitus, ear fullness, and fluctuating hearing loss. What is the trap?",
    answers: ["Calling it BPPV despite auditory symptoms", "Recognizing Ménière disease", "Noting hearing changes", "Noting episode duration"],
    correct: 0,
    explanation: "Trap: BPPV causes brief positional vertigo without hearing loss. Vertigo with tinnitus/fullness/hearing loss suggests Ménière disease."
  },
  ...
  // PSYCHIATRY — TRAP
  {
    topic: "Psychiatry",
    mode: "Trap",
    vignette: "Patient has depressive symptoms for 3 weeks after losing a job, with guilt, early awakening, poor concentration, anhedonia, and impaired function. What is the trap?",
    answers: ["Calling it adjustment disorder solely because a stressor exists", "Recognizing major depressive disorder", "Counting symptom duration", "Assessing impairment"],
    correct: 0,
    explanation: "Trap: a stressor does not exclude MDD. If full depressive syndrome lasts more than 2 weeks with impairment, MDD is likely."
  },
  {
    topic: "Psychiatry",
    mode: "Trap",
    vignette: "Patient has decreased need for sleep, grandiosity, pressured speech, risky spending, and hospitalization. What is the trap?",
    answers: ["Calling it hypomania despite hospitalization", "Recognizing mania", "Assessing severity", "Assessing impairment"],
    correct: 0,
    explanation: "Trap: hospitalization or marked impairment makes it mania, not hypomania."
  },
  {
    topic: "Psychiatry",
    mode: "Trap",
    vignette: "Patient worries about health, finances, work, and family most days for many months. What is the trap?",
    answers: ["Calling it panic disorder without discrete attacks", "Recognizing GAD", "Noting multiple domains", "Noting chronicity"],
    correct: 0,
    explanation: "Trap: generalized chronic worry across domains is GAD. Panic disorder centers on recurrent panic attacks and fear of recurrence."
  },
  {
    topic: "Psychiatry",
    mode: "Trap",
    vignette: "Patient has unexpected panic attacks and then avoids stores because of fear of another attack. Cardiac workup is normal. What is the trap?",
    answers: ["Repeating endless cardiac workups despite classic panic pattern", "Recognizing panic disorder", "Assessing avoidance", "Noting anticipatory anxiety"],
    correct: 0,
    explanation: "Trap: medical causes should be considered, but recurrent unexpected attacks with anticipatory avoidance after negative evaluation fit panic disorder."
  },
  {
    topic: "Psychiatry",
    mode: "Trap",
    vignette: "Patient has nightmares, avoidance, hypervigilance, and detachment 4 months after assault. What is the trap?",
    answers: ["Calling it acute stress disorder after 4 months", "Recognizing PTSD", "Assessing trauma exposure", "Assessing avoidance"],
    correct: 0,
    explanation: "Trap: acute stress disorder is within the first month. Persistent trauma symptoms beyond 1 month fit PTSD."
  },
  {
    topic: "Psychiatry",
    mode: "Trap",
    vignette: "Patient checks the stove for an hour daily despite knowing it is irrational. What is the trap?",
    answers: ["Calling it psychosis despite preserved insight", "Recognizing OCD", "Noting compulsions", "Noting intrusive anxiety"],
    correct: 0,
    explanation: "Trap: preserved insight with intrusive fears and repetitive rituals favors OCD, not psychosis."
  },
  {
    topic: "Psychiatry",
    mode: "Trap",
    vignette: "Patient has hallucinations, delusions, disorganized speech, social withdrawal, and functional decline for 8 months. What is the diagnosis?",
    answers: ["Schizophrenia", "Brief psychotic disorder", "Schizophreniform disorder", "Delusional disorder"],
    correct: 0,
    explanation: "Trap: duration matters. Psychosis with functional decline for more than 6 months fits schizophrenia."
  },
  {
    topic: "Psychiatry",
    mode: "Trap",
    vignette: "Patient binge eats, vomits, uses laxatives, and has normal BMI. What is the trap?",
    answers: ["Calling it anorexia because purging occurs", "Recognizing bulimia nervosa", "Checking BMI", "Asking about compensatory behaviors"],
    correct: 0,
    explanation: "Trap: purging can occur in bulimia or anorexia. Normal BMI with bingeing and compensatory behaviors favors bulimia nervosa."
  },
  {
    topic: "Psychiatry",
    mode: "Trap",
    vignette: "Heavy alcohol user develops tremor, sweating, tachycardia, hypertension, and anxiety 10 hours after last drink. What is the trap?",
    answers: ["Calling it panic attack", "Recognizing alcohol withdrawal", "Using cessation timing", "Noting autonomic instability"],
    correct: 0,
    explanation: "Trap: autonomic instability and tremor after alcohol cessation indicate withdrawal, not primary panic."
  },
  {
    topic: "Psychiatry",
    mode: "Trap",
    vignette: "Patient has grandiosity, entitlement, need for admiration, exploitation, and lack of empathy. What is the trap?",
    answers: ["Calling it borderline personality disorder because relationships are difficult", "Recognizing narcissistic personality disorder", "Noting grandiosity", "Noting lack of empathy"],
    correct: 0,
    explanation: "Trap: interpersonal conflict alone is nonspecific. Grandiosity and need for admiration point to narcissistic personality disorder."
  },
  ...
  // RHEUMATOLOGY — TRAP
  {
    topic: "Rheumatology",
    mode: "Trap",
    vignette: "Patient has symmetric MCP/wrist swelling and morning stiffness lasting 90 minutes. What is the trap?",
    answers: ["Calling it osteoarthritis because hands hurt", "Recognizing rheumatoid arthritis", "Noting prolonged morning stiffness", "Noting MCP/wrist pattern"],
    correct: 0,
    explanation: "Trap: OA typically affects DIP/CMC and has brief stiffness. Prolonged inflammatory MCP/wrist stiffness suggests RA."
  },
  {
    topic: "Rheumatology",
    mode: "Trap",
    vignette: "Patient has photosensitive rash, oral ulcers, joint pain, fatigue, and pleuritic pain. What is the diagnosis?",
    answers: ["Systemic lupus erythematosus", "Fibromyalgia", "Osteoarthritis", "Gout"],
    correct: 0,
    explanation: "Trap: multisystem inflammatory features should not be dismissed as nonspecific pain. This pattern fits SLE."
  },
  {
    topic: "Rheumatology",
    mode: "Trap",
    vignette: "Patient has sudden first MTP monoarthritis after beer and steak. What is the trap?",
    answers: ["Calling it cellulitis without joint pattern recognition", "Recognizing gout", "Noting podagra", "Noting dietary trigger"],
    correct: 0,
    explanation: "Trap: red painful toe can look like cellulitis, but abrupt first MTP arthritis after alcohol/purines is gout."
  },
  {
    topic: "Rheumatology",
    mode: "Trap",
    vignette: "Older patient with OA has recurrent acute knee monoarthritis. What is the likely diagnosis?",
    answers: ["Pseudogout", "Rheumatoid arthritis", "Polymyalgia rheumatica", "Fibromyalgia"],
    correct: 0,
    explanation: "Trap: recurrent acute knee attacks in an older patient with OA suggest pseudogout, not RA."
  },
  {
    topic: "Rheumatology",
    mode: "Trap",
    vignette: "Older patient has shoulder/hip stiffness but normal true strength. What is the trap?",
    answers: ["Calling it polymyositis despite normal strength", "Recognizing polymyalgia rheumatica", "Distinguishing pain from weakness", "Noting age"],
    correct: 0,
    explanation: "Trap: PMR causes pain/stiffness, not true muscle weakness. True proximal weakness suggests myositis."
  },
  {
    topic: "Rheumatology",
    mode: "Trap",
    vignette: "Older patient has new temporal headache, jaw claudication, and transient vision loss. What should not be delayed?",
    answers: ["High-dose glucocorticoids", "Treatment until biopsy confirms", "Vision-risk assessment", "Temporal artery evaluation"],
    correct: 0,
    explanation: "Trap: do not delay steroids for biopsy in suspected GCA with visual symptoms. Treat immediately to prevent blindness."
  },
  {
    topic: "Rheumatology",
    mode: "Trap",
    vignette: "Patient has Raynaud phenomenon, tight shiny fingers, reflux, and dysphagia. What is the trap?",
    answers: ["Calling reflux isolated GERD", "Recognizing systemic sclerosis", "Noting sclerodactyly", "Noting esophageal dysmotility"],
    correct: 0,
    explanation: "Trap: reflux plus Raynaud and skin tightening suggests systemic sclerosis, not isolated GERD."
  },
  {
    topic: "Rheumatology",
    mode: "Trap",
    vignette: "Young man has chronic back pain worse with rest and improved with exercise. What is the trap?",
    answers: ["Calling it mechanical back strain", "Recognizing ankylosing spondylitis", "Noting inflammatory pattern", "Checking spinal mobility"],
    correct: 0,
    explanation: "Trap: inflammatory back pain improves with exercise and worsens with rest, unlike typical mechanical strain."
  },
  {
    topic: "Rheumatology",
    mode: "Trap",
    vignette: "Patient has dry eyes, dry mouth, dental caries, and parotid swelling. What is the diagnosis?",
    answers: ["Sjögren syndrome", "Diabetes mellitus only", "Dehydration only", "Allergic conjunctivitis only"],
    correct: 0,
    explanation: "Trap: sicca symptoms with dental caries/parotid swelling suggest Sjögren syndrome, not simple dehydration."
  },
  {
    topic: "Rheumatology",
    mode: "Trap",
    vignette: "Patient has palpable purpura, hematuria, pulmonary hemorrhage, and rising creatinine. What is the trap?",
    answers: ["Calling it isolated bronchitis", "Recognizing small-vessel vasculitis", "Noting renal involvement", "Noting pulmonary-renal syndrome"],
    correct: 0,
    explanation: "Trap: cough with blood plus renal injury and purpura is pulmonary-renal vasculitis, not isolated bronchitis."
  },
    // OB/GYN — TRAP
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "34F at 34 weeks gestation has painless bright red vaginal bleeding. What should be avoided before placental location is confirmed?",
    answers: ["Digital cervical exam", "Ultrasound evaluation", "Maternal vital sign assessment", "Fetal monitoring"],
    correct: 0,
    explanation: "Trap: do not perform digital cervical exam in suspected placenta previa before ultrasound confirms placental location. It can provoke severe bleeding."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "28F at 35 weeks gestation has painful vaginal bleeding, uterine tenderness, and contractions. What is the trap?",
    answers: ["Calling it placenta previa because bleeding is present", "Recognizing placental abruption", "Assessing fetal status", "Checking maternal stability"],
    correct: 0,
    explanation: "Trap: placenta previa is classically painless. Painful bleeding with uterine tenderness suggests placental abruption."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "30F at 32 weeks gestation has BP 168/110 mmHg, headache, visual symptoms, and RUQ pain, but only trace proteinuria. What is the trap?",
    answers: ["Excluding severe preeclampsia because protein is trace", "Recognizing severe features", "Treating severe-range BP seriously", "Assessing neurologic symptoms"],
    correct: 0,
    explanation: "Trap: severe preeclampsia can be diagnosed by severe features even if proteinuria is minimal. Severe BP with headache/visual symptoms/RUQ pain is high risk."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Pregnant patient with severe hypertension has a generalized seizure. What medication is first-line to prevent recurrent seizures?",
    answers: ["Magnesium sulfate", "Phenytoin", "Levetiracetam", "Diazepam only"],
    correct: 0,
    explanation: "Trap: eclampsia is treated with magnesium sulfate, not routine antiepileptic monotherapy."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "25F at 30 weeks gestation has contractions every 6 minutes. She says they improved slightly after drinking water, but cervical dilation has progressed on repeat exam. What is the most likely diagnosis?",
    answers: ["Preterm labor", "Braxton Hicks contractions", "Round ligament pain", "Placenta previa"],
    correct: 0,
    explanation: "Trap: do not dismiss regular contractions as Braxton Hicks just because hydration helped slightly. Cervical change before 37 weeks confirms preterm labor."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Labor tracing shows recurrent late decelerations. What is the trap?",
    answers: ["Calling them benign fetal sleep cycles", "Recognizing uteroplacental insufficiency", "Assessing maternal hypotension", "Repositioning/resuscitation as needed"],
    correct: 0,
    explanation: "Trap: late decelerations are not fetal sleep cycles. They reflect uteroplacental insufficiency."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Labor tracing shows abrupt variable decelerations that vary in timing and shape. What is the most likely cause?",
    answers: ["Cord compression", "Uteroplacental insufficiency", "Maternal fever", "Fetal sleep"],
    correct: 0,
    explanation: "Trap: variable decelerations indicate cord compression, not uteroplacental insufficiency. Late decelerations point to uteroplacental insufficiency."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Postpartum patient has heavy bleeding and a soft boggy enlarged uterus. What is the trap?",
    answers: ["Looking only for lacerations before treating atony", "Recognizing uterine atony", "Uterine massage", "Uterotonic therapy"],
    correct: 0,
    explanation: "Trap: a boggy uterus means uterine atony and should be treated promptly. Lacerations cause bleeding with a firm uterus."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Postpartum patient after prolonged labor and cesarean has fever, uterine tenderness, and foul lochia. What is the diagnosis?",
    answers: ["Endometritis", "Mastitis", "Normal postpartum fever", "Viral URI"],
    correct: 0,
    explanation: "Trap: postpartum fever with uterine tenderness and foul lochia is endometritis, especially after cesarean/prolonged labor."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Breastfeeding patient has fever and a painful red wedge-shaped area on the breast without fluctuance. What advice is usually wrong?",
    answers: ["Stop breastfeeding permanently", "Continue milk removal", "Treat mastitis", "Assess for abscess if fluctuance develops"],
    correct: 0,
    explanation: "Trap: mastitis usually does not require permanent breastfeeding cessation. Continued milk removal is generally encouraged."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient has pelvic pain, fever, cervical motion tenderness, and mucopurulent discharge. Pregnancy test is negative. What is the trap?",
    answers: ["Waiting for all STI tests before treatment", "Recognizing PID clinically", "Treating empirically when suspected", "Assessing pregnancy status"],
    correct: 0,
    explanation: "Trap: PID is treated empirically when clinically suspected; do not wait for all test results."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient has sudden severe unilateral pelvic pain with nausea and vomiting. Pregnancy test is negative. What is the trap?",
    answers: ["Excluding ovarian torsion because pregnancy test is negative", "Recognizing torsion", "Urgent gynecologic evaluation", "Considering ovarian blood flow limitations"],
    correct: 0,
    explanation: "Trap: negative pregnancy test excludes ectopic pregnancy, not ovarian torsion. Sudden unilateral pain with vomiting is torsion until proven otherwise."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient has chronic cyclic pelvic pain, deep dyspareunia, and infertility. Pelvic exam is subtle. What is the trap?",
    answers: ["Excluding endometriosis because exam is not dramatic", "Recognizing endometriosis", "Noting cyclicity", "Noting infertility"],
    correct: 0,
    explanation: "Trap: endometriosis can have a subtle exam. Cyclic pain, dyspareunia, and infertility are key."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient has heavy painful menses and a uniformly enlarged tender uterus. What is the diagnosis?",
    answers: ["Adenomyosis", "Leiomyomas", "Endometrial cancer", "Ovarian torsion"],
    correct: 0,
    explanation: "Trap: uniformly enlarged tender uterus suggests adenomyosis. Fibroids more often cause an irregular enlarged uterus."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient has heavy menstrual bleeding, pelvic pressure, and an enlarged irregular uterus. What is the diagnosis?",
    answers: ["Leiomyomas", "Adenomyosis", "Endometriosis", "Cervicitis"],
    correct: 0,
    explanation: "Trap: irregular enlarged uterus with bulk symptoms points to leiomyomas, not adenomyosis."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "58F with obesity, hypertension, and diabetes has postmenopausal bleeding. What should not be done?",
    answers: ["Reassure as normal menopause", "Evaluate endometrium", "Consider endometrial cancer", "Treat bleeding as abnormal"],
    correct: 0,
    explanation: "Trap: postmenopausal bleeding is never normal and requires evaluation, especially with endometrial cancer risk factors."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient has thin gray fishy vaginal discharge and elevated pH. What is the trap?",
    answers: ["Treating as candidiasis because discharge is present", "Recognizing bacterial vaginosis", "Using pH", "Using odor/appearance"],
    correct: 0,
    explanation: "Trap: candidiasis usually causes thick white discharge, intense itching, and normal pH. Thin fishy discharge with elevated pH is BV."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient has intense vulvar itching, thick white discharge, and normal vaginal pH. What is the diagnosis?",
    answers: ["Vulvovaginal candidiasis", "Bacterial vaginosis", "Trichomoniasis", "Cervicitis"],
    correct: 0,
    explanation: "Trap: normal pH helps distinguish candidiasis from BV/trichomoniasis, which typically elevate pH."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient has frothy yellow-green discharge and strawberry cervix. What is the trap?",
    answers: ["Calling it bacterial vaginosis only", "Recognizing trichomoniasis", "Treating partner when indicated", "Noting strawberry cervix"],
    correct: 0,
    explanation: "Trap: strawberry cervix and frothy yellow-green discharge point to trichomoniasis, not BV alone."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient has irregular menses, acne, hirsutism, and infertility. What is the trap?",
    answers: ["Calling it normal irregular cycles without considering hyperandrogenism", "Recognizing PCOS", "Checking pregnancy test", "Assessing metabolic risk"],
    correct: 0,
    explanation: "Trap: irregular cycles with hyperandrogenism suggest PCOS, not normal variation alone."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient has amenorrhea and galactorrhea with negative pregnancy test. What should not be missed?",
    answers: ["Hyperprolactinemia", "Normal stress only", "Mittelschmerz", "Endometriosis"],
    correct: 0,
    explanation: "Trap: galactorrhea plus amenorrhea after pregnancy is excluded points to hyperprolactinemia."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient develops secondary amenorrhea after dilation and curettage for postpartum hemorrhage. What is the diagnosis?",
    answers: ["Asherman syndrome", "PCOS", "Primary ovarian insufficiency", "Menopause"],
    correct: 0,
    explanation: "Trap: uterine instrumentation followed by amenorrhea suggests intrauterine adhesions, or Asherman syndrome."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "52F has hot flashes, vaginal dryness, sleep disturbance, and 12 months without menses. What is the trap?",
    answers: ["Calling it PCOS", "Recognizing menopause", "Using 12 months of amenorrhea", "Noting vasomotor symptoms"],
    correct: 0,
    explanation: "Trap: PCOS causes irregular menses in reproductive-age patients. Twelve months of amenorrhea with vasomotor symptoms fits menopause."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "17F has primary amenorrhea, normal breast development, cyclic pelvic pain, and bulging bluish hymen. What is the trap?",
    answers: ["Diagnosing Turner syndrome despite normal puberty", "Recognizing imperforate hymen", "Noting cyclic pain", "Noting obstructed outflow"],
    correct: 0,
    explanation: "Trap: normal breast development means estrogen is present. Primary amenorrhea with cyclic pain and bulging hymen is obstructed outflow."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "16F has primary amenorrhea, short stature, webbed neck, broad chest, and no breast development. What is the diagnosis?",
    answers: ["Turner syndrome", "Imperforate hymen", "PCOS", "Pregnancy"],
    correct: 0,
    explanation: "Trap: absent breast development with Turner stigmata suggests gonadal dysgenesis, not outflow obstruction."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient wants highly effective reversible contraception but forgets daily pills. What is the trap?",
    answers: ["Offering calendar method as similarly effective", "Recommending LARC", "Considering IUD/implant", "Considering adherence"],
    correct: 0,
    explanation: "Trap: fertility-awareness/calendar methods are much less effective than LARC and require adherence."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Patient with migraine with aura who smokes asks for combined oral contraceptives. What is unsafe?",
    answers: ["Estrogen-containing contraception", "Progestin-only method", "Copper IUD", "Levonorgestrel IUD"],
    correct: 0,
    explanation: "Trap: estrogen-containing contraception increases stroke risk in migraine with aura, especially with smoking."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Pregnant patient with Rh-negative blood has vaginal bleeding. What is commonly forgotten?",
    answers: ["Rho(D) immune globulin when indicated", "Avoiding all ultrasounds", "Immediate hysterectomy", "Stopping prenatal care"],
    correct: 0,
    explanation: "Trap: Rh-negative pregnant patients with bleeding may need Rho(D) immune globulin to prevent alloimmunization."
  },
  {
    topic: "OB/GYN",
    mode: "Trap",
    vignette: "Shoulder dystocia occurs after delivery of the fetal head. What should not be done first?",
    answers: ["Excessive traction on fetal head", "McRoberts maneuver", "Suprapubic pressure", "Calling for help"],
    correct: 0,
    explanation: "Trap: do not apply excessive traction in shoulder dystocia; it increases brachial plexus injury risk. Use maneuvers like McRoberts and suprapubic pressure."
  },
  ...
  // PEDIATRICS — TRAP
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "6-week-old has projectile nonbilious vomiting after feeds and remains hungry. What is the trap?",
    answers: ["Calling it reflux because vomiting is nonbilious", "Recognizing pyloric stenosis", "Noting projectile quality", "Noting olive mass"],
    correct: 0,
    explanation: "Trap: nonbilious vomiting can still be surgical. Projectile vomiting with hunger and olive mass is pyloric stenosis."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "8-month-old has intermittent severe crying, knees to chest, and bloody mucus stool. What is the diagnosis?",
    answers: ["Intussusception", "Viral gastroenteritis", "Pyloric stenosis", "Constipation"],
    correct: 0,
    explanation: "Trap: intermittent symptoms can falsely reassure, but episodic pain plus currant-jelly stool is intussusception."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Newborn has bilious vomiting and abdominal distension. What is unsafe?",
    answers: ["Reassuring as reflux", "Urgent evaluation for malrotation/volvulus", "Surgical concern", "Recognizing bilious vomiting as abnormal"],
    correct: 0,
    explanation: "Trap: bilious vomiting in a newborn is not reflux. It is malrotation with volvulus until proven otherwise."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Newborn has delayed meconium and explosive stool after rectal exam. What is the trap?",
    answers: ["Calling it simple constipation", "Recognizing Hirschsprung disease", "Noting delayed meconium", "Noting explosive stool"],
    correct: 0,
    explanation: "Trap: delayed meconium with distension and explosive stool after rectal exam suggests Hirschsprung disease, not simple constipation."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Toddler has barky cough, hoarseness, and inspiratory stridor after viral prodrome. He is not drooling. What should not be overcalled?",
    answers: ["Epiglottitis", "Croup", "Viral upper airway inflammation", "Subglottic narrowing"],
    correct: 0,
    explanation: "Trap: croup causes barky cough and hoarseness. Epiglottitis has toxic appearance, drooling, muffled voice, and tripod posture."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Infant in winter has URI symptoms followed by wheezing and poor feeding. What is the trap?",
    answers: ["Diagnosing asthma after first infant wheezing episode", "Recognizing bronchiolitis", "Supportive care", "Assessing hydration"],
    correct: 0,
    explanation: "Trap: first-time wheezing in an infant after viral URI is bronchiolitis, not necessarily asthma."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Child has high fever, drooling, muffled voice, and tripod position. What should be avoided?",
    answers: ["Aggressive throat examination with tongue depressor", "Airway management readiness", "Recognizing epiglottitis", "Keeping child calm"],
    correct: 0,
    explanation: "Trap: do not aggressively examine the throat in suspected epiglottitis; it can precipitate airway obstruction."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Toddler suddenly coughs and wheezes while playing with toys. What is the trap?",
    answers: ["Calling it asthma without considering aspiration", "Recognizing foreign body aspiration", "Noting sudden onset", "Noting unilateral findings"],
    correct: 0,
    explanation: "Trap: sudden cough/wheeze during play suggests foreign body aspiration, especially with unilateral findings."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Child has 5 days of fever, conjunctivitis, cracked lips, swollen hands, rash, and cervical lymphadenopathy. What should not be missed?",
    answers: ["Kawasaki disease", "Scarlet fever only", "Viral exanthem only", "Allergic reaction"],
    correct: 0,
    explanation: "Trap: prolonged fever with mucocutaneous/extremity findings suggests Kawasaki disease and coronary risk."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Child has migratory arthritis, carditis, and chorea weeks after untreated sore throat. What is the trap?",
    answers: ["Ignoring prior untreated strep because throat symptoms resolved", "Recognizing acute rheumatic fever", "Checking evidence of strep", "Assessing carditis"],
    correct: 0,
    explanation: "Trap: acute rheumatic fever occurs after strep symptoms may have resolved."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Child refuses to bear weight, has fever, and a painful hip. What should not delay management?",
    answers: ["Assuming transient synovitis despite fever and refusal to bear weight", "Recognizing septic arthritis", "Urgent joint evaluation", "Assessing inflammatory markers"],
    correct: 0,
    explanation: "Trap: fever plus refusal to bear weight is septic arthritis until proven otherwise."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "School-aged boy has painless limp and limited hip abduction without fever. What is the trap?",
    answers: ["Calling it septic arthritis without fever/toxic findings", "Recognizing Legg-Calvé-Perthes disease", "Assessing hip range of motion", "Considering avascular necrosis"],
    correct: 0,
    explanation: "Trap: chronic painless limp without fever in a school-aged child suggests Legg-Calvé-Perthes, not septic arthritis."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Overweight adolescent has knee pain but exam shows limited hip internal rotation and externally rotated leg. What is the trap?",
    answers: ["Treating as isolated knee injury", "Recognizing SCFE", "Examining the hip", "Noting referred pain"],
    correct: 0,
    explanation: "Trap: SCFE often presents with referred knee pain. Always examine the hip."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Adolescent athlete has tibial tubercle tenderness and activity-related anterior knee pain. What is the diagnosis?",
    answers: ["Osgood-Schlatter disease", "Septic arthritis", "SCFE", "Legg-Calvé-Perthes disease"],
    correct: 0,
    explanation: "Trap: focal tibial tubercle pain in an adolescent athlete is Osgood-Schlatter disease, not intra-articular infection."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Toddler has bruises in different stages and fracture inconsistent with history. What is the trap?",
    answers: ["Accepting the caregiver story despite mismatch", "Recognizing nonaccidental trauma", "Documenting injuries carefully", "Protecting the child"],
    correct: 0,
    explanation: "Trap: history-injury mismatch and bruises in different stages are red flags for nonaccidental trauma."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Toddler has brief generalized seizure with fever and returns quickly to baseline. What is the trap?",
    answers: ["Treating as status epilepticus", "Recognizing simple febrile seizure", "Noting brief duration", "Noting generalized seizure"],
    correct: 0,
    explanation: "Trap: brief generalized fever-associated seizure with rapid recovery is simple febrile seizure, not status epilepticus."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Infant has clusters of brief flexion spasms after waking and developmental regression. What is the trap?",
    answers: ["Calling them normal startle reflexes", "Recognizing infantile spasms", "Noting regression", "Urgent evaluation"],
    correct: 0,
    explanation: "Trap: clustered spasms with developmental regression are infantile spasms, not normal startle."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "School-aged child has frequent brief staring spells with immediate return to activity. What is the trap?",
    answers: ["Calling it daydreaming/ADHD only", "Recognizing absence seizures", "Noting immediate return", "Noting eyelid fluttering"],
    correct: 0,
    explanation: "Trap: frequent brief staring episodes with immediate return can be absence seizures."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Child has polyuria, polydipsia, weight loss, vomiting, and deep rapid breathing. What is the trap?",
    answers: ["Calling it gastroenteritis because vomiting is present", "Recognizing DKA", "Noting Kussmaul breathing", "Checking glucose/ketones"],
    correct: 0,
    explanation: "Trap: vomiting with polyuria, polydipsia, weight loss, and Kussmaul breathing suggests DKA, not simple gastroenteritis."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Child has cola-colored urine, edema, hypertension, and recent throat infection. What is the trap?",
    answers: ["Calling it UTI because urine changed color", "Recognizing PSGN", "Noting hypertension/edema", "Using post-strep timing"],
    correct: 0,
    explanation: "Trap: cola-colored urine with edema and hypertension is nephritic syndrome, not simple UTI."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Child has edema and heavy proteinuria with normal BP and no RBC casts. What is the trap?",
    answers: ["Calling it PSGN because recent viral illness occurred", "Recognizing minimal change disease", "Noting nephrotic pattern", "Checking urine sediment"],
    correct: 0,
    explanation: "Trap: viral illness can precede minimal change disease. Edema and heavy proteinuria without active sediment is nephrotic, not nephritic."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Child has palpable purpura, abdominal pain, arthralgia, hematuria, and normal platelets. What is the trap?",
    answers: ["Calling it ITP despite normal platelets", "Recognizing IgA vasculitis", "Noting abdominal pain", "Noting renal involvement"],
    correct: 0,
    explanation: "Trap: purpura with normal platelets plus abdominal/joint/renal findings is IgA vasculitis, not ITP."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Infant has jaundice, vomiting, hepatomegaly, cataracts, and poor feeding after milk exposure. What is the trap?",
    answers: ["Calling it physiologic jaundice", "Recognizing galactosemia", "Stopping galactose/lactose exposure", "Noting cataracts"],
    correct: 0,
    explanation: "Trap: physiologic jaundice does not cause vomiting, hepatomegaly, cataracts, and systemic illness after milk feeds."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Infant has persistent jaundice, pale stools, dark urine, and hepatomegaly. What is the trap?",
    answers: ["Calling it breast milk jaundice", "Recognizing biliary atresia", "Noting pale stools", "Urgent evaluation"],
    correct: 0,
    explanation: "Trap: pale stools and dark urine suggest conjugated hyperbilirubinemia from biliary obstruction, not benign breast milk jaundice."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Toddler has poor eye contact, repetitive movements, impaired social communication, and regression. Hearing screen is normal. What is the diagnosis?",
    answers: ["Autism spectrum disorder", "ADHD", "Normal toddler behavior", "Oppositional defiant disorder"],
    correct: 0,
    explanation: "Trap: normal hearing helps exclude hearing loss, but social communication deficits plus restricted/repetitive behaviors suggest autism spectrum disorder."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Child has inattention, impulsivity, and hyperactivity at home and school for more than 6 months. What is the trap?",
    answers: ["Diagnosing based on school issues alone without multiple settings", "Recognizing ADHD when multiple settings are involved", "Assessing duration", "Assessing impairment"],
    correct: 0,
    explanation: "Trap: ADHD requires symptoms in more than one setting. School-only issues can suggest learning or environmental problems."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Newborn has cyanosis that worsens with feeding and improves with crying. What is the trap?",
    answers: ["Assuming primary cardiac cyanosis only", "Recognizing choanal atresia", "Using feeding/crying pattern", "Assessing nasal airway"],
    correct: 0,
    explanation: "Trap: cyanosis improved by crying suggests nasal obstruction such as choanal atresia, not primary cardiac cyanosis."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Infant has cyanotic spells relieved by squatting or knee-chest position. What is the diagnosis?",
    answers: ["Tetralogy of Fallot", "VSD only", "ASD", "Innocent murmur"],
    correct: 0,
    explanation: "Trap: cyanotic spells relieved by squatting are classic tet spells from tetralogy of Fallot."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Premature infant has early respiratory distress and diffuse atelectasis. What is the trap?",
    answers: ["Calling it transient tachypnea because all newborn tachypnea is TTN", "Recognizing neonatal RDS", "Noting prematurity", "Noting surfactant deficiency"],
    correct: 0,
    explanation: "Trap: prematurity plus diffuse atelectasis suggests surfactant-deficiency RDS, not TTN."
  },
  {
    topic: "Pediatrics",
    mode: "Trap",
    vignette: "Term infant delivered by cesarean has mild tachypnea that improves over 24 hours. What is the diagnosis?",
    answers: ["Transient tachypnea of newborn", "Neonatal RDS", "Meconium aspiration", "Congenital pneumonia"],
    correct: 0,
    explanation: "Trap: term cesarean infant with mild self-limited tachypnea fits TTN, not surfactant-deficiency RDS."
  },
    // SURGERY / EMERGENCY — TRAP
  {
    topic: "Surgery/Emergency",
    mode: "Trap",
    vignette: "22M has abdominal pain that began near the umbilicus and migrated to the right lower quadrant. He had one loose stool, but now has anorexia, nausea, and focal McBurney point tenderness. What is the most likely diagnosis?",
    answers: ["Appendicitis", "Viral gastroenteritis", "Diverticulitis", "Renal colic"],
    correct: 0,
    explanation: "Trap: do not dismiss migratory RLQ pain as gastroenteritis because of one loose stool. Migration, anorexia, nausea, and McBurney tenderness point to appendicitis."
  },
  {
    topic: "Surgery/Emergency",
    mode: "Trap",
    vignette: "37F has RUQ pain after fatty food. Prior episodes resolved quickly, but this episode persists with fever and a positive Murphy sign. What is the most likely diagnosis?",
    answers: ["Acute cholecystitis", "Biliary colic", "GERD", "IBS"],
    correct: 0,
    explanation: "Trap: do not call persistent febrile RUQ pain biliary colic. Fever and Murphy sign indicate acute cholecystitis."
  },
  {
    topic: "Surgery/Emergency",
    mode: "Trap",
    vignette: "59M with heavy alcohol use has severe epigastric pain radiating to the back and repeated vomiting. He says it feels like bad heartburn. What is the most likely diagnosis?",
    answers: ["Acute pancreatitis", "GERD", "Peptic ulcer disease", "Small bowel obstruction"],
    correct: 0,
    explanation: "Trap: do not label back-radiating epigastric pain after alcohol as reflux. The pattern fits acute pancreatitis."
  },
  {
    topic: "Surgery/Emergency",
    mode: "Trap",
    vignette: "62M taking NSAIDs has sudden severe abdominal pain, rigid abdomen, and free air under the diaphragm on upright chest x-ray. What is the most likely diagnosis?",
    answers: ["Perforated viscus", "Small bowel obstruction", "Appendicitis", "Diverticulitis"],
    correct: 0,
    explanation: "Trap: do not treat sudden peritonitic abdominal pain as indigestion. Free air under the diaphragm indicates perforated viscus."
  },
  {
    topic: "Surgery/Emergency",
    mode: "Trap",
    vignette: "69F with prior abdominal surgery has crampy abdominal pain, vomiting, distension, obstipation, and high-pitched bowel sounds. She passed a little gas earlier. What is the most likely diagnosis?",
    answers: ["Small bowel obstruction", "Gastroenteritis", "Irritable bowel syndrome", "Acute pancreatitis"],
    correct: 0,
    explanation: "Trap: passing a small amount of gas does not exclude bowel obstruction. Prior surgery plus crampy pain, vomiting, distension, obstipation, and high-pitched sounds suggest SBO."
  },
  {
    topic: "Surgery/Emergency",
    mode: "Trap",
    vignette: "75M with atrial fibrillation has sudden severe abdominal pain. Exam is surprisingly benign, but pain is extreme and he later has bloody stool. What is the most likely diagnosis?",
    answers: ["Mesenteric ischemia", "Viral gastroenteritis", "Appendicitis", "Constipation"],
    correct: 0,
    explanation: "Trap: do not be reassured by a benign early abdominal exam. Pain out of proportion in a patient with atrial fibrillation suggests mesenteric ischemia."
  },
  {
    topic: "Surgery/Emergency",
    mode: "Trap",
    vignette: "72M smoker has sudden severe abdominal and back pain, hypotension, and a pulsatile abdominal mass. He has chronic back pain at baseline. What is the most likely diagnosis?",
    answers: ["Ruptured abdominal aortic aneurysm", "Musculoskeletal back pain", "Renal colic", "Pancreatitis"],
    correct: 0,
    explanation: "Trap: do not attribute shock with abdominal/back pain to chronic back pain. Older smoker plus hypotension and pulsatile mass suggests ruptured AAA."
  },
  {
    topic: "Surgery/Emergency",
    mode: "Trap",
    vignette: "64M has sudden severe leg pain with a cold pale foot, numbness, and absent pulses. He previously had calf pain while walking. What is the most likely diagnosis?",
    answers: ["Acute limb ischemia", "Deep vein thrombosis", "Cellulitis", "Peripheral neuropathy"],
    correct: 0,
    explanation: "Trap: chronic claudication history should not make you miss an acute arterial occlusion. Sudden pain, pallor, pulselessness, coldness, and numbness indicate acute limb ischemia."
  },
  {
    topic: "Surgery/Emergency",
    mode: "Trap",
    vignette: "26M wakes with sudden severe testicular pain and nausea. He has no dysuria or fever. Exam shows high-riding testis and absent cremasteric reflex. What is the most likely diagnosis?",
    answers: ["Testicular torsion", "Epididymitis", "Hydrocele", "Varicocele"],
    correct: 0,
    explanation: "Trap: do not wait for urinary symptoms. Sudden severe pain, nausea, high-riding testis, and absent cremasteric reflex indicate testicular torsion."
  },
  {
    topic: "Surgery/Emergency",
    mode: "Trap",
    vignette: "31M has colicky flank pain radiating to the groin, nausea, pacing/restlessness, and hematuria. He is afebrile. What is the most likely diagnosis?",
    answers: ["Ureteral stone", "Pyelonephritis", "Appendicitis", "Testicular torsion"],
    correct: 0,
    explanation: "Trap: do not call severe flank pain pyelonephritis without infection signs. Afebrile colicky flank-to-groin pain with hematuria fits ureteral stone."
  },

  // QUALITY / PATIENT SAFETY — TRAP
  {
    topic: "Quality/Patient Safety",
    mode: "Trap",
    vignette: "Two hospitalized patients have similar names. A nurse checks only the room number before giving medication, and the wrong patient receives the drug. What is the best prevention strategy?",
    answers: ["Use two patient identifiers", "Use room number as the main identifier", "Ask whether the patient recognizes the medication", "Move one patient after every admission"],
    correct: 0,
    explanation: "Trap: room number is not a reliable patient identifier. Use two identifiers, such as name and date of birth or medical record number."
  },
  {
    topic: "Quality/Patient Safety",
    mode: "Trap",
    vignette: "A patient deteriorates overnight because a pending potassium result was mentioned verbally but omitted from written sign-out. What system change best prevents this?",
    answers: ["Standardized handoff tool", "Longer shifts", "More informal verbal reminders", "Fewer handoffs"],
    correct: 0,
    explanation: "Trap: do not rely on memory or informal reminders for critical pending tasks. Standardized handoff tools reduce omissions."
  },
  {
    topic: "Quality/Patient Safety",
    mode: "Trap",
    vignette: "Before surgery, the consent and schedule list different laterality. The surgeon says he remembers the correct side. What should be done before incision?",
    answers: ["Perform a preoperative time-out", "Proceed based on surgeon memory", "Wait until postoperative debriefing", "Ask the family after anesthesia"],
    correct: 0,
    explanation: "Trap: surgeon memory is not a safety system. Wrong-site risk requires a formal time-out confirming patient, procedure, site, and laterality."
  },
  {
    topic: "Quality/Patient Safety",
    mode: "Trap",
    vignette: "Several ICU patients develop central-line infections. Review shows sterile technique varies by operator during insertion. What intervention is most appropriate?",
    answers: ["Central-line insertion checklist", "Longer antibiotic courses for all patients", "Daily blood cultures for all central lines", "More frequent room cleaning only"],
    correct: 0,
    explanation: "Trap: antibiotics treat infection but do not fix inconsistent insertion technique. A central-line checklist standardizes prevention steps."
  },
  {
    topic: "Quality/Patient Safety",
    mode: "Trap",
    vignette: "A patient returns with severe hypoglycemia after misunderstanding insulin discharge instructions. The discharge paperwork was complete. What should have been used?",
    answers: ["Teach-back", "Longer written instructions only", "Avoiding all insulin", "Only asking, “Do you understand?”"],
    correct: 0,
    explanation: "Trap: complete paperwork does not prove understanding. Teach-back asks the patient to explain the plan in their own words."
  },
  {
    topic: "Quality/Patient Safety",
    mode: "Trap",
    vignette: "A patient’s home diuretic is unintentionally omitted on admission, causing worsening heart failure. The medication appeared in an outside pharmacy record but was not added to admission orders. What process failed?",
    answers: ["Medication reconciliation", "Daily weight measurement", "Insurance verification", "Dietary counseling"],
    correct: 0,
    explanation: "Trap: the problem is not just heart failure monitoring. This is a medication reconciliation failure."
  },
  {
    topic: "Quality/Patient Safety",
    mode: "Trap",
    vignette: "A clinic wants to test a new reminder script with one physician for one week before expanding it. What quality improvement method is this?",
    answers: ["Plan-Do-Study-Act cycle", "Root cause analysis", "Case-control study", "Cost-effectiveness analysis"],
    correct: 0,
    explanation: "Trap: small rapid testing of a workflow change is PDSA, not a full research trial or root cause analysis."
  },
  {
    topic: "Quality/Patient Safety",
    mode: "Trap",
    vignette: "A hospital reviews a fatal medication error to identify system contributors such as labeling, staffing, and order-entry design. What method is being used?",
    answers: ["Root cause analysis", "PDSA cycle", "Patient satisfaction survey", "Cost-minimization analysis"],
    correct: 0,
    explanation: "Trap: after a serious adverse event, the goal is to find system causes, not blame one person. This is root cause analysis."
  },
  {
    topic: "Quality/Patient Safety",
    mode: "Trap",
    vignette: "A wrong medication dose is caught by a nurse before reaching the patient. No harm occurs. What should happen?",
    answers: ["Report it as a near miss", "Ignore it because no harm occurred", "Delete the order silently", "Punish the nurse"],
    correct: 0,
    explanation: "Trap: near misses still reveal system vulnerabilities. They should be reported and used for safety improvement."
  },
  {
    topic: "Quality/Patient Safety",
    mode: "Trap",
    vignette: "A patient with limited English proficiency is asked to sign consent after her adult son translates the procedure. The procedure has major risks. What is the best next step?",
    answers: ["Use a professional medical interpreter", "Proceed because family translated", "Use gestures and simplified English", "Ask the son to sign instead"],
    correct: 0,
    explanation: "Trap: family translation is not adequate for high-stakes informed consent. Use a professional medical interpreter."
  },
    // =========================================================
  // TRIGGER MODE
  // =========================================================
